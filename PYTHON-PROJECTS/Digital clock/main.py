...
clk.geometry("1358x700+0+0") #width,height,x-axis, y-axis we have kept 0 because we will start from left top
clk.config(bg = "#0C1E28") # you can set any color you want
...
lb_mn = Label(clk, text="12", font = ("Times 20 bold",75,"bold"),bg = "#00BEA4",fg = "white")
lb_mn.place(x=520,y=200,width=150,height=150)

lb_mn_txt = Label(clk, text = "MINUTES",font=("Times 20 bold",20,"bold"),bg = "#00BEA4",fg = "white")
